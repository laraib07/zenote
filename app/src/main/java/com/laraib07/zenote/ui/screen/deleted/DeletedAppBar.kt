...
fun DeletedScreenAppBar(
    ...
    TopAppBar(
        modifier = modifier,
        title = {
            Text(text = stringResource(id = R.string.deleted_folder))
        },
        navigationIcon = {
            IconButton(
...
@Preview
@Composable
fun DeletedScreenAppBarPrev() {
    DeletedScreenAppBar(onTapDrawer = { /*TODO*/ }, onSearchActionTap = {})
}